 ...
 * crashed the entire conversation tree on a missing API). Every fence and
 * toolview card renders under this boundary; on error the block degrades to a
 * compact inline alert instead of unmounting the tree.
...
interface ErrorBoundaryProps {
  /** What the block is, shown in the fallback alert (fence / tool). */
  label?: string
  children: ReactNode
}
